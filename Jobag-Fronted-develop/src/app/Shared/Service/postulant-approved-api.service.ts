...
import {PostulantApproved} from "../Interface/postulant-approved";
import {Interview} from "../Interface/interview";
...
export class PostulantApprovedApiService {
  ...
  basePath = 'https://jobagweb.herokuapp.com/api/postulants';
